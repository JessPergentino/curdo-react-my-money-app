...
}) // a função selector tem o estado como parametro e o nome do atributo que queremos extrair do formulario - o resultado é colocado nas propiedades do componente
